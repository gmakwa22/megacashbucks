...
<div id="iframeslide"><iframe id="iframe" src="licence/{{ $licloc }}" width="100%" height="450"></iframe></div>
<button id="buttonlic" style="float: right; border: 0;"><img width="132" height="184" src="licence/placeholder-licence.jpg" align="right" class="et_bloom_hide_mobile et_bloom_image_no_animation et_bloom_image" alt="" srcset="licence/placeholder-licence.jpg 451w, licence/placeholder-licence.jpg" sizes="(max-width: 251px) 100vw, 251px" /></button>
<br />
...
<div id="bg-content">
	@include('global.paydaycustomers')
...
{{--	  @include('global.review-section') --}}
	...
	<section id="cash-loan-fast" class="bg-linear red">
		...
		<p class="text">These are just some of the ways in which we stand out from the crowd. We have a chart you can review to see the difference.</p></br></br>
		</div>
		</article>
	</section>
