...
<section class="marketing-service page-section-ptb">
	<div class="container">
		<div class="col-xs-12">
			<p class="title">Aberdeen Ontario</p>
			...
			<p class="text text-justify">So, if you’re looking for a short-term loan, with a trusted, direct lender, {{$privname}} is the company for you. Our Code of Conduct is drawn from industry best practices, ensuring a transparent and responsible lending process wherever you are, in Aberdeen or across Ontario.</p>
		...
		<div class="row">
			...
			<div class="col-lg-6 sm-mt-30">
				...
				<ul class="list-group">
					...
					<li class="list-group-item">- Best Places to Eat in Aberdeen, Ontario</li>
					...
					<li class="list-group-item">- Best Places to Stay in Aberdeen, Ontario</li>
					...
					<li class="list-group-item"><a href="https://globalnews.ca/tag/aberdeen-street/" target="_blank">- Local News for Aberdeen, Ontario</a></li>
