		...
		<div class="row">
			...
			<div class="col-lg-6 sm-mt-30">
				...
				<ul class="list-group">
					...
					<li class="list-group-item">- Best Places to Go Shopping in Omemee, Ontario</li>
					...
					<li class="list-group-item"><a href="https://staycanada.ca/ontario/omemee/" target="_blank">- Best Places to Stay in Omemee, Ontario</a></li>
