		...
		<div class="row">
			...
			<div class="col-lg-6 sm-mt-30">
				...
				<ul class="list-group">
					...
					<li class="list-group-item"><a href="https://www.niagarathisweek.com/ontario-communities/port-colborne/" target="_blank">- Local News for Port Colborne, Ontario</a></li>
