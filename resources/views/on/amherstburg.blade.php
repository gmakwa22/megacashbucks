		...
		<div class="row">
			...
			<div class="col-lg-6 sm-mt-30">
				...
				<ul class="list-group">
					...
					<li class="list-group-item"><a href="https://www.amherstburg.ca/en/live-and-play/public-transit-service.aspx" target="_blank">- Public Transportation Options in Amherstburg, Ontario</a></li>
					<li class="list-group-item"><a href="https://www.reservations.com/Hotels/amherstburg-on" target="_blank">- Best Places to Stay in Amherstburg, Ontario</a></li>
