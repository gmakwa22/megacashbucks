		...
		<div class="row">
			...
			<div class="col-lg-6 sm-mt-30">
				...
				<ul class="list-group">
					...
					<li class="list-group-item"><a href="https://www.familydaysout.com/kids-things-to-do-canada/bradford/on" target="_blank">- Best Things to do with the Kids in Bradford, Ontario</a></li>
					<li class="list-group-item"><a href="https://globalnews.ca/tag/bradford/" target="_blank">- Local News for Bradford, Ontario</a></li>
