		...
		<div class="row">
			...
			<div class="col-lg-6 sm-mt-30">
				...
				<ul class="list-group">
					...
					<li class="list-group-item"><- Best Places to Go Shopping in Guelph, Ontario</li>
					...
					<li class="list-group-item"><a href="https://kitchener.ctvnews.ca/guelph" target="_blank">- Local News for Guelph, Ontario</a></li>
