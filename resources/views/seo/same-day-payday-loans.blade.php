<section class="marketing-service page-section-ptb">
	...
	<h2 class="small-title center text-center">Get up to $1,500. Low Rates. 5 minutes e-transfer</h2><br>
				...
				<p class="text text-justify">In fact, the entire process can be completed on the <a href="/short-term-loans" rel="noopener">Pay Day website</a>, or even on the go via your smartphone with the <a href="/payday-loan-app-canada" rel="noopener">Pay Day online loan app</a>, for iOS and Android devices, allowing for instant approval and fast release of funds.</p>
