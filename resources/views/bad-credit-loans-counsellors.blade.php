...
<p class="text"><a href="http://www.creditcounsellingcanada.ca/" target="_blank"  onclick="ga('send', 'event', 'external links', 'credit consellors', 'http://creditcounsellingcanada.ca');"><i class="fa fa-globe"></i>creditcounsellingcanada.ca</a><br>
...
<p class="text"><a href="https://www.nomoredebts.org/canada/alberta/credit-counselling.html" target="_blank"  onclick="ga('send', 'event', 'external links', 'credit consellors', 'http://nomoredebts.org');"><i class="fa fa-globe"></i>nomoredebts.org</a><br>
...
<h2 class="counsellorrs-name2">CREDIT COUNSELLING SOCIETY</h2>
<p class="text"><a href="https://www.nomoredebts.org/canada/bc/credit-counselling.html" target="_blank"  onclick="ga('send', 'event', 'external links', 'credit consellors', 'http://nomoredebts.org');"><i class="fa fa-globe"></i>nomoredebts.org</a><br>
<i class="fa fa-phone"></i>1–888-527–8999</p>
</article>
</div>
<div class="col-xs-12 col-sm-6 col-md-5 col-md-offset-1">
...
<p class="text"><a href="http://oaccs.com/" target="_blank"  onclick="ga('send', 'event', 'external links', 'credit consellors', 'http://oaccs.com');"><i class="fa fa-globe"></i>oaccs.com</a><br>
...
<p class="text"><a href="https://www.solveyourdebts.com/english/index.php" target="_blank"  onclick="ga('send', 'event', 'external links', 'credit consellors', 'https://solveyourdebts.com');"><i class="fa fa-globe"></i>solveyourdebts.com</a><br>
