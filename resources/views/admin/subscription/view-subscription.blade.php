          ...
          <tbody>
            ...
            <tr class="gradeX">
              ...
              <td class="center">
                ...
                <a href="{{ url('/admin/delete-subscription/'. $subscript->id ) }}" class="btn btn-danger btn-mini" onclick="return confirm('Are you sure to delete this Subsciption?')"><i class="fa fa-trash"></i></a>
              </td>
            </tr>
            @endforeach
         </tbody>
