...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">Update Buyer</div>
            <div class="panel-body">

            <form  action='{{ url("admin/customers/{$user->id}/update") }}'' class="form-horizontal" method="post" role="form" id="create_formm1" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <!-- <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <select type="text" name="role" class="form-control" id="create_role">
                            ...
                            <option value="4" @if(old("role",$user->role) !== "2" && old("role",$user->role) !== "3") selected="selected" @endif >Buyer</option>
                        </select>
                        @if ($errors->has('role'))
                            <span class="help-block">
