...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">Update Agency</div>
            <div class="panel-body">

            <form  action='{{ url("admin/adminagents/{$user->id}/update") }}'' class="form-horizontal" method="post" role="form" id="create_formm1" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="email" class="form-control" value="{{ old('email',$user->email ) }}" placeholder="Email" value="{{ old('uname',$user->name ) }}"/>
                        @if ($errors->has('email'))
                            <span class="help-block">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-10">
                        <input type="text" name="phone_no" class="form-control"  placeholder="Telephone" value="{{ old('phone_no',$user->phone_no ) }}"/>
                ...
                <div class="form-group" id="show_admin_option">
                    ...
                    <div class="col-md-10">
                        <select type="text" name="user_admin" class="form-control">
                            <option value="">-- Select admin agent --</option>
