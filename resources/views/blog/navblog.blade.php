       ...
       <div class="col-lg-12 col-md-12">
        ...
        <div class="menu-bar">
         ...
         <li><a href="{{url('/blog')}}">HOME</a>
            ...
            <li><a href="{{url('/how-its-done')}}">MEGACASHBUCKS LOANS</a>
            </li>
            <li><a href="{{url('/contact')}}">CONTACT MEGACASHBUCKS</a>
            </li>
            <li><a href="{{url('/faq')}}">FAQ</a>
            </li>
            <li><a href="{{$corpsignin}}" onclick="ga('send', 'event', 'buttons', 'click', 'login');">Login</a>
            </li>
            <li><a href="{{$corpregister}}" onclick="ga('send', 'event', 'buttons', 'click', 'topsign');" class="topsignup">Get a Loan</a>
            </li>
