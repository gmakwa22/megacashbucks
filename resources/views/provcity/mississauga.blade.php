<section class="marketing-service page-section-ptb">
		<div class="container">
			<div class="col-xs-12">
				...
				<p class="text text-justify">{{$privname}} is a top online direct licensed Canadian lender, that provides quick and easy access to <a href="/short-term-loans" target="_blank" rel="noopener">payday loans</a> to residents of Mississauga, Ontario.</p>
