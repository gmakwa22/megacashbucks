<section class="marketing-service page-section-ptb">
		<div class="container">
			...
			<p class="text text-justify">We offer you a payday loan that can be approved in just minutes. And once approved, just 5 minutes after signing your contract we’ll have your money e-transferred into your bank account. So, whether you need the car or computer repaired, emergency dental work or last-minute tuition fees, our payday loans can do the trick.  </p>
				<a href="/british-columbia-cities">View British Columbia Cities</a>
					<p class="text text-justify">Mega Cash Bucks offers quick and easy Online Payday Loans British Columbia Abbotsford, Kelowna, Vancouver, Victoria and throughout British Columbia. You have access to our cash advance program and our great flexible installment plan. Tailor your loan to your needs, fast and easy.</p>
			</div>
		</div>
</section>
     ...
     <div class="row">
      ...
      <div class="col-lg-6 sm-mt-30">
				...
				<ul class="list-group">
								...
								<li class="list-group-item"><a href="https://www.workbc.ca/jobs-careers/find-jobs/jobs.aspx#/job-search" target="_blank" rel="noopener">Jobs in British Columbia, Canada</a></li>
