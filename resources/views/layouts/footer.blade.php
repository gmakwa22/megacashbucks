...
<li><a itemprop="sameAs" href="http://www.facebook.com/" title="Facebook PayDay.ca" class="facebook" target="_blank" rel="noopener" onClick="ga('send', 'event', 'social', 'suivre', 'facebook');"><i class="fa fa-facebook"></i></a></li>
...
<li><a itemprop="sameAs" href="#" title="Twitter PayDay.ca" class="twitter" target="_blank" rel="noopener" onClick="ga('send', 'event', 'social', 'suivre', 'twitter');"><i class="fa fa-twitter"></i></a></li>
...
<div class="col-xs-12 col-sm-12 col-md-9">
	<div class="col-sm-6 col-md-4 footer-left">
		...
		<li><a href="https://uat.megacashbucks.com/Lending#/">Apply right now!</a></br></li>
		</ul>
	</div>
	<div class="col-sm-6 col-md-4 footer-left">
		<h3>Help</h3>
	...
	<div class="col-sm-6 col-md-4 footer-left">
		...
		<li id="cred"><a href="{{ url('/responsible-lending' )}}" onClick="ga('send', 'event', 'footer', 'click', 'responsible lending');">Our pledge of responsible lending</a></li>
	...
	<div id="bande-logo">
		<div id="copyright">
			<article class="container">
				<span>
				 Copyright ©2019 <a href="{{url('/')}}">MegaCashBucks</a> | All rights reserved
				</span>
			</article>
		</div>
	</div>
...
<strong><span itemprop="name">Mega Cash Bucks</span></strong>, proudly <strong><span class="uppercase">canadian</span></strong> owned and operated, offers personalized payday loans and fast cash advances to thousands of Canadians in <strong><span>British Columbia</span></strong> (<a href="/payday-loans-vancouver" onclick="ga('send', 'event', 'footer', 'click', 'Vancouver');">Vancouver</a>,  <a href="/payday-loans-surrey" onclick="ga('send', 'event', 'footer', 'click', 'Surrey');">Surrey</a> ,  <a href="/payday-loans-burnaby" onclick="ga('send', 'event', 'footer', 'click', 'Burnaby');">Burnaby</a>  and others), in <strong><span>Alberta</span></strong> ( <a href="/payday-loans-calgary" onclick="ga('send', 'event', 'footer', 'click', 'calgary');">Calgary</a> ,  <a href="/payday-loans-edmonton" onclick="ga('send', 'event', 'footer', 'click', 'edmonton');">Edmonton</a> ,  <a href="/payday-loans-lethbridge" onclick="ga('send', 'event', 'footer', 'click', 'Lethbridge');">Lethbridge</a> ,  <a href="/payday-loans-red-deer" onclick="ga('send', 'event', 'footer', 'click', 'Red Deer');">Red Deer</a> ,  <a href="/payday-loans-wood-buffalo" onclick="ga('send', 'event', 'footer', 'click', 'Wood Buffalo');">Wood Buffalo</a> ,  <a href="/payday-loans-medicine-hat" onclick="ga('send', 'event', 'footer', 'click', 'Medicine Hat');">Medicine Hat</a> ,  <a href="/payday-loans-airdrie" onclick="ga('send', 'event', 'footer', 'click', 'Airdrie');">Airdrie</a> , and others), in <strong><span>Saskatchewan</span></strong> ( Saskatoon ,  Regina  and others), in <strong><span>Ontario</span></strong> ( <a href="/payday-loans-toronto" onclick="ga('send', 'event', 'footer', 'click', 'toronto');">Payday Loans Toronto</a> ,  <a href="/payday-loans-ottawa" onclick="ga('send', 'event', 'footer', 'click', 'ottawa');">Ottawa</a> ,  <a href="/payday-loans-mississauga" title="Mississauga, Ontario" onclick="ga('send', 'event', 'footer', 'click', 'Mississauga');">Mississauga</a> ,  <a href="/payday-loans-brampton" title="Brampton, Ontario" onclick="ga('send', 'event', 'footer', 'click', 'Brampton');">Brampton</a> ,  <a href="/payday-loans-hamilton" title="Hamilton, Ontario" onclick="ga('send', 'event', 'footer', 'click', 'Hamilton');">Hamilton</a> ,  <a href="/payday-loans-markham" title="Markham, Ontario" onclick="ga('send', 'event', 'footer', 'click', 'Markham');">Markham</a> ,  <a href="/payday-loans-niagara-falls" title="Niagara Falls, Ontario" onclick="ga('send', 'event', 'footer', 'click', 'Niagara Falls');">Niagara Falls</a>  and others), in <strong><span>Nova Scotia</span></strong> ( <a href="/payday-loans-halifax" onclick="ga('send', 'event', 'footer', 'click', 'halifax');">Halifax</a> ,  <a href="/payday-loans-cape-breton" onclick="ga('send', 'event', 'footer', 'click', 'cape breton');">Cape Breton</a> ,  <a href="/payday-loans-dartmouth" onclick="ga('send', 'event', 'footer', 'click', 'Dartmouth');">Dartmouth</a> ,  <a href="/payday-loans-truro" onclick="ga('send', 'event', 'footer', 'click', 'truro');">Truro</a> ,  <a href="/payday-loans-sydney-nova-scotia" onclick="ga('send', 'event', 'footer', 'click', 'sydney');">Sydney</a>  and others), in <strong><span>New Brunswick</span></strong> ( <a href="/payday-loans-moncton" onclick="ga('send', 'event', 'footer', 'click', 'moncton');">Moncton</a> ,  <a href="/payday-loans-saint-john" onclick="ga('send', 'event', 'footer', 'click', 'Saint John');">Saint John</a> ,  <a href="/payday-loans-fredericton" onclick="ga('send', 'event', 'footer', 'click', 'Fredericton');">Fredericton</a>  and others) as well as in <strong><span>Manitoba</span></strong> ( <a href="/payday-loans-winnipeg" onclick="ga('send', 'event', 'footer', 'click', 'winnipeg');">Winnipeg</a> ,  <a class="city" href="/payday-loans-dauphin" title="Dauphin, Manitoba">Dauphin</a> ,  <a class="city" href="/payday-loans-morden" title="Morden, Manitoba">Morden</a> ,  <a class="city" href="/payday-loans-portage-la-prairie" title="Portage La Prairie, Manitoba">Portage La Prairie</a> ,  <a class="city" href="/payday-loans-selkirk" title="Selkirk, Manitoba">Selkirk</a> ,  <a class="city" href="/payday-loans-the-pas" title="The Pas, Manitoba">The Pas</a> ,  <a class="city" href="/payday-loans-winkler" title="Winkler, Manitoba">Winkler</a> ,  Brandon ,  Steinbach ,  Thompson  and others).
...
<b>Renewals</b><br>
Mega Cash Bucks does not automatically renew loans.<br>
...
<span itemprop="annualPercentageRate" itemscope="" itemtype="http://schema.org/QuantitativeValue">
License #XXXXXX - <span itemprop="name">British Columbia</span><br>
</span>
<span itemprop="annualPercentageRate" itemscope="" itemtype="http://schema.org/QuantitativeValue">
			...
			<div class="modal-content">
				<div class="modal-body">
					...
					<div class="container-fluid license scrollbar">
						<div class="col-xs-12">
							<div class="title">
							<h5>Province of British Columbia License will be here soon!</h5>
							<!-- <p>PayDay makes responsible short term loans, fully compliant in all Canadian provinces.<b> Our business is transparent and guided by provincial consumer protection laws. </b></p>
							<div class="secured"></div>
							<div class="secured2"></div> -->
							</div>
...
<div tabindex="-1" class="modal fade modal-prov" id="newfoundland-and-labrador-dialog-modal" role="dialog" style="display: none;">
	...
	<script>
				...
				document.getElementById("test").innerHTML +=  $('.loan-slider').length;
    ...
    <script>
        jQuery('.btn-step2').click(function(e){
            ...
            window.location.href = "https://uat.megacashbucks.com/Lending#/stepRegister?amount="+jQuery('#loan-slider').val()+"&term="+term_val+"&product=64282c09-1560-40c3-a867-a6ffbafee10d";
        })
    </script>
