...
<section class="page-section-ptb" style="padding: 40px 0px 20px 0px !important;">
 <div class="container">
  <div class="row">
    <div class="col-lg-4 col-md-4">
       <div class="section-title mb-20">
          <h2 style="color:white; margin-top:0px;">We do things differently</h2>
          <p style="color:white;" class="text-justify">Mega Cash Bucks is a provider of short-term loans to help Canadians get on with their lives, when financial uncertainty arises. We provide safe and quick access to the funds that really make a difference in people’s lives.</p>
        </div>
