...
<img src="{{url('/images/search-icon.png')}}" alt="Search" width="28"> <input type="text" id="search" class="form-control forminput" onkeyup="instantSearchKeys()" autocomplete="off" placeholder="Key words..." /><br>
...
<li>
<h3 id="2" data-toggle="collapse" data-target="#demo"><img src="{{url('/images/clock.png')}}" alt="contact hour" width="30"> Opening Hours<span>+</span></h3>
<div class="block-p active opening collapse" id="demo">
<p class="text">Whether you’re using phone or email, our Customer Service Advisors are ready to help: <br><br><strong>Monday to Friday 9am to 9pm EST</strong> (Eastern Standard Time)<br><strong>Saturday 9am to 5pm EST</strong> (Eastern Standard Time).<br>
<strong>Sunday 12pm to 5pm EST</strong> (Eastern Standard Time).</p>
<p class="text">
We’re happy to help.
</p>
</div>
...
<li>
<h3 id="4" data-toggle="collapse" data-target="#demo1"><img src="{{url('/images/location.png')}}" alt="contact adress" width="22" class="marg2"> Address<span>+</span></h3>
<div class="block-p active address collapse" id="demo1">
<div class="col-xs-12 col-sm-4 alpha">
<h4><img src="{{url('/images/FL2.jpg')}}" alt="{{$privname}} logo" width="90"></h4>
<div class="clearfix"></div>
<div class="alert alert-info">We cannot accept customers or conduct any transactions from this location.</div>
<p class="text">Vancouver British Columbia V6B 6M2</p>
</div>
<?php
$array_add = "Vancouver British Columbia V6B 6M2";
$add = str_replace(" ","%",$array_add);
?>
<div id="map" class="col-xs-12 col-sm-7">
<iframe width="100%" height="300" src="https://maps.google.com/maps?&q=<?php echo $add; ?>&ie=UTF8&t=&z=14&iwloc=B&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"><a href="https://www.mapsdirections.info/en/journey-planner.htm"></iframe></div>
</div>
</li>
</ul>
</div>
...
<div class="alert alert-info">{{$privname}} is on the leading edge of the tech-based smart loan industry. We make fast, easy and transparent loans available to our customers. Customer Service Agents are available exclusively through email during the following times:</div><br>
