...
<center><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d20860.7233731677!2d-117.29982407277346!3d49.18935817654819!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x53633a37e126fd73%3A0x89463fec17eaa1de!2sSalmo%2C%20BC%20V0G%201Z0!5e0!3m2!1sen!2sca!4v1635200891123!5m2!1sen!2sca" width="500" height="350" style="border:0;" allowfullscreen="" loading="lazy"></iframe></center>
      ...
      <div class="col-lg-6 sm-mt-30">
				...
				<ul class="list-group">
					<li class="list-group-item"><a href="https://salmo.ca/discover-salmo/recreation-attractions/" target="_blank" >- Best Attractions in Salmo, British Columbia</a></li>
					<li class="list-group-item"><a href="https://www.tripadvisor.ca/Restaurants-g1886272-Salmo_Kootenay_Rockies_British_Columbia.html" target="_blank" >- Best Places to Eat in Salmo, British Columbia</a></li>
					<li class="list-group-item"><a href="https://gokootenays.com/shopping-services/" target="_blank" >- Best Places to Go Shopping in Salmo, British Columbia</a></li>
					<li class="list-group-item"><a href="https://www.bctransit.com/west-kootenay/schedules-and-maps/route-overview?route=72" target="_blank" >- Public Transportation Options in Salmo, British Columbia</a></li>
					<li class="list-group-item"><a href="https://www.booking.com/city/ca/salmo.html" target="_blank" >- Best Places to Stay in Salmo, British Columbia</a></li>
					<li class="list-group-item"><a href="https://salmo.ca/discover-salmo/recreation-attractions/" target="_blank" >- Best Things to do with the Kids in Salmo, British Columbia</a></li>
					<li class="list-group-item"><a href="https://globalnews.ca/tag/salmo/" target="_blank" >- Local News for Salmo, British Columbia</a></li>
					<li class="list-group-item"><a href="https://www.theweathernetwork.com/ca/weather/british-columbia/salmo" target="_blank" >- Weather in Salmo, British Columbia</a></li>
					</ul>
      </div>
     </div>
  </div>
