...
<center><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d20861.901163180617!2d-119.56998707277984!3d49.186564776529174!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x5482ea3632327a43%3A0x234f69bbfc8453b0!2sOliver%2C%20BC!5e0!3m2!1sen!2sca!4v1635185038945!5m2!1sen!2sca" width="500" height="350" style="border:0;" allowfullscreen="" loading="lazy"></iframe></center>
      ...
      <div class="col-lg-6 sm-mt-30">
				...
				<ul class="list-group">
					<li class="list-group-item"><a href="https://exploreoliverbc.com/things-to-do" target="_blank" >- Best Attractions in Oliver, British Columbia</a></li>
					<li class="list-group-item"><a href="https://exploreoliverbc.com/restaurants-oliver" target="_blank" >- Best Places to Eat in Oliver, British Columbia</a></li>
					<li class="list-group-item"><a href="https://www.yelp.ca/search?cflt=shopping&find_loc=Oliver%2C+BC" target="_blank" >- Best Places to Go Shopping in Oliver, British Columbia</a></li>
					<li class="list-group-item"><a href="https://oliver.ca/bc-transit/" target="_blank" >- Public Transportation Options in Oliver, British Columbia</a></li>
					<li class="list-group-item"><a href="https://www.booking.com/city/ca/oliver.html" target="_blank" >- Best Places to Stay in Oliver, British Columbia</a></li>
					<li class="list-group-item"><a href="https://exploreoliverbc.com/things-to-do" target="_blank" >- Best Things to do with the Kids in Oliver, British Columbia</a></li>
					<li class="list-group-item"><a href="https://oliverdailynews.com/" target="_blank" >- Local News for Oliver, British Columbia</a></li>
					<li class="list-group-item"><a href="https://www.theweathernetwork.com/ca/weather/british-columbia/oliver" target="_blank" >- Weather in Oliver, British Columbia</a></li>
					</ul>
      </div>
     </div>
  </div>
