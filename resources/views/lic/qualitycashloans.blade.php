...
<div id="iframeslide"><iframe id="iframe" src="licence/qualitycashloans/BusinessLicense-2021.pdf" width="100%" height="450"></iframe></div>
<button id="buttonlic" onclick="myFunction()" style="float: right;"><img width="132" height="184" src="licence/qualitycashloans/placeholder-licence.jpg" align="right" class="et_bloom_hide_mobile et_bloom_image_no_animation et_bloom_image" alt="" srcset="licence/qualitycashloans/placeholder-licence.jpg 451w, licence/qualitycashloans/placeholder-licence.jpg" sizes="(max-width: 251px) 100vw, 251px" /></button>
<br />
