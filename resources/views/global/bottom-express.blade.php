...
<ul>
<li id="elloan" class="active1"><a href="#how-wrk" data-toggle="tab">How to qualify for an express payday loan?</a></li>
<li id="aprfee"><a href="#apr" data-toggle="tab">How can I get an express loan with bad credit?</a></li>
<li id="gcash"><a href="#getcash" data-toggle="tab">Can I get an express loan the same day?</a></li>
<li id="manloan"><a href="#mloan" data-toggle="tab">Which loan company is best for express payday loans?</a></li>
<li id="reloan"><a href="#repay" data-toggle="tab">Who can I contact regarding my express loan?</a></li>
</ul>
</div>
...
<h3>How can I get an express loan with bad credit?</h3>
<p class="newtext">There are no minimum credit score requirements to get an express loan. While a credit check is performed as part of the approval process, it’s just one of many things that we look at and having bad credit is not disqualifying.
...
<h3>Can I get an express loan the same day?</h3>
<p class="newtext">With an express loan in Canada, you can get the money you need that same day any time of day, any day of the week, any week of the year. Since everything is done online and is automated, round-the-clock service is possible.<br><br>
...
<h3>Which loan company is best for express payday loans?</h3>
<p>As a leader in the industry, Pay Day is considered the best online express payday loans in Canada. It is the preferred choice for many of our customers, for a variety of different reasons. The speed and convenience as well as affordable competitive interest rates are two more reasons. As a bonus perk, a cash back rewards program that is very appealing to many customers.<br><br>
...
<h3>Who can I contact regarding my express loan?</h3>
<p>A team of dedicated and knowledgeable customer experience advisors that are available by phone and e-mail to help you. We also have an online knowledge base of articles and <a href="{{url('/faq')}}" rel="noopener">payday loan FAQs</a> that answer the most common questions about your options when it comes to express payday loans. Most people find the answers they’re seeking within these resources, which we provide for your convenience. So much of our online lending process is automated, that we figured a help option should be as well.<br><br>
But we recognize and respect that sometimes, you just need to talk to a real person. Please, feel free to reach out and <a href="{{url('/contact')}}" rel="noopener">contact Pay Day</a>, and we’ll be happy to address any questions, concerns, or issues you may be having. Our team is based in Canada and speak both official languages. They are available from 9 am to 9 pm Eastern time Monday to Friday, 9 am to 5 pm Eastern time on Saturdays, and 12 pm to 5 pm Eastern time on Sundays.
</p>
</div>
</div>
