        ...
        <div class="ui compact menu" id="provinces">
          <div class="form-control ui simple dropdown item selection" tabindex="0" id="select-selectProvince"><select name="selectProvince" title="Provinces">
          ...
          <option id="manitoba" data-loan-selected-province="false" data-loan-percent="23" value="manitoba" selected>Manitoba</option>
          ...
          </select><i class="dropdown icon"></i><div class="default text">Please select a province</div><div class="menu" tabindex="-1"><div class="item" data-value="alberta">Alberta</div><div class="item" data-value="british-columbia" selected>British Columbia</div><div class="item" data-value="ontario">Ontario</div><div class="item" data-value="new-brunswick">New Brunswick</div><div class="item" data-value="saskatchewan">Saskatchewan</div><div class="item" data-value="manitoba">Manitoba</div><div class="item" data-value="quebec">Quebec</div><div class="item" data-value="newfoundland-and-labrador">Newfoundland and Labrador</div></div></div>
          </div>
        <!-- <div><a href="#" id="licence_province">Lender licences</a></div> --><br><br>
    <a onclick="return gtag_report_conversion('{{ $corpregister }}');" href="{{ $corpregister }}" class="submit btn btn-green btn-step2 tracking-tsign">APPLY NOW FOR FAST APPROVAL</a>
        </div>
