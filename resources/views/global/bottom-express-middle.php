...
<section class="choose-X46 white-bg page-section-ptb">
  <div class="objects-left">
     <img class="objects-1 img-fluid" src="/images2/03.png" alt="">
   </div>
...
<section class="choose-X46 white-bg page-section-ptb">
     ...
     <div class="row justify-content-center">
       <div class="col-lg-8">
            <div class="section-title text-center">
               <h1 class="title">What’s the best loan for you?asdfasdf</h1>
            ...
            <div class="col-md-6 col-sm-6 mb-30">
              <div class="feature-text text-left">
                ...
                <div class="feature-info">
                  ...
                  <p class="text">Completely confidential and secure, guaranteed! We use the same high security standards like the banks.</p>
                </div>
              </div>
            </div>
            <div class="col-md-6 col-sm-6 mb-30">
              <div class="feature-text text-left">
                ...
                <div class="feature-info">
                  ...
                  <p class="text">Our support staff. Always ready and available to answer any questions that you may have to ensure you get the loan you need.</p>
                </div>
              </div>
            </div>
         </div>
            ...
            <div class="col-md-6 col-sm-6 mb-30">
              <div class="feature-text text-left">
                ...
                <div class="feature-info">
                  ...
                  <p class="text">Our lending process has no hidden fees. What you see is what you get. That’s our promise as fully compliant licensed lenders under provincial law and regulation.</p>
                </div>
              </div>
            </div>
            <div class="col-md-6 col-sm-6 mb-30">
              <div class="feature-text text-left">
                ...
                <div class="feature-info">
                  ...
                  <p class="text">Your interest fee is unchanged, whether it’s better for you to pay in 1, 2 or 3 equal repayments.</p>
                </div>
              </div>
            </div>
         </div>
            ...
            <div class="col-md-6 col-sm-6">
              <div class="feature-text text-left">
                ...
                <div class="feature-info">
                  ...
                  <p class="text">You’ll know instantly when you’re approved for your loan and what repayment schedule of 1, 2 or 3 installments best suits your needs.</p>
                </div>
              </div>
            </div>
         </div>
  ...
  <div class="objects-right">
     <img class="objects-4 img-fluid" src="/images2/04.png" alt="">
   </div>
</section>
