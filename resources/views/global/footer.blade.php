...
footer section#footer .footer-left a:link, footer section#footer .footer-left a:visited {
    color: #989898;
    font-size: 18px;
    letter-spacing: .5px;
    line-height: 1.5;
...
<a href="#"><img src="{{asset('images/FL2.jpg')}}" alt="{{ $privname }}"></a>
</div>
<div class="col-xs-12 footer-social-media">
<!-- <ul class="list-inline" itemscope itemtype="http://schema.org/Organization">
<link itemprop="url" href="#">
<li><a itemprop="sameAs" href="https://www.facebook.com/{{ $nametogether }}/" title="Facebook {{ $privname }}" class="facebook" target="_blank" rel="noopener" onClick="ga('send', 'event', 'social', 'suivre', 'facebook');"><i class="fa fa-facebook"></i></a></li>
...
<li><a itemprop="sameAs" href="https://twitter.com/{{ $nametogether }}/" title="Twitter {{ $privname }}" class="twitter" target="_blank" rel="noopener" onClick="ga('send', 'event', 'social', 'suivre', 'twitter');"><i class="fa fa-twitter"></i></a></li>
<li><a itemprop="sameAs" href="#" title="Google-plus {{ $privname }}" class="google" target="_blank" rel="noopener" onClick="ga('send', 'event', 'social', 'suivre', 'google-plus');"><i class="fa fa-google"></i></a></li>
</ul> -->
</div>
</div>
...
<center>
  ...
  Maximum charges permitted in British Columbia for payday loan: 15% of the principal. We charge: 15% of the principal. For a $300 loan for 14 days: Total cost for borrowing = $45 Annual Percentage rate = 391.07% {{ $privphone or '' }}
</br></br>
...
<strong>Easy online payday loans in Canada, Same day fast cash Ontario ON, Online loans British Colombia BC, Get cash money in  Alberta AB, Payday loan Saskatchewan SK.</strong>
<br>{{--
