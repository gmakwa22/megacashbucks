...
<section class="marketing-service page-section-ptb mt-20">
		<div class="container">
			<div class="col-xs-12">
				<h2 class="small-title mb-1">Payday Loans Ohio</h2>
				...
				<p class="text text-justify">So, if you’re looking for a short-term loan, with a trusted, direct lender, {{$comp}} Loans is the company for you. Our Code of Conduct is drawn from industry best practices, ensuring a transparent and responsible lending process wherever you are, in Ohio or across CA.</p>
...
<section class="marketing-service gray-bg page-section-ptb mb-30">
  <div class="container">
    ...
    <iframe width="560" height="315" src="https://www.youtube.com/embed/-OzWcPzr2hk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        </div>
        <div class="col-lg-12">
          <center>
