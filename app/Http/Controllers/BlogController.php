   ...
   public function blog() {
      ...
      $data = ["bannerbg" => "land/$getmimg.jpg", "licpr" => "ab", "spprov" => "New Brunswick", "headpg" => "Mega Cash Bucks Blog", "headtxtcolor" => "white", "headalt" => "payday loans bc", "tags" => $tags];
       ...
       $data = ["bannerbg" => "land/$getmimg.jpg", "licpr" => "ab", "spprov" => "New Brunswick", "headpg" => "Top 15 Work From Home Jobs in Canada.", "headtxtcolor" => "white", "headalt" => "payday loans bc", "tags" => "payday loans, easy money, work from home"];
           SEOMeta::setTitle('Top 15 Work From Home Jobs in Canada.');
           SEOMeta::setDescription('Before the COVID-19 pandemic, there weren’t many opportunities for work-from-home jobs in Canada that offered significant income.');
         ...
         public function canadachildbenefit()
         {
          ...
          public function thiswinterisgoingtobetoughonyourwallet()
          {
          	 ...
          	 SEOMeta::setTitle('This Winter is Going to be Tough on your Wallet, Canada');
          ...
          {
          	$data = ["bannerbg" => "images/falls.jpg", "licpr" => "on", "spprov" => "Niagara Falls", "headpg" => "Payday Loans - The Low-Cost Option", "headtxtcolor" => "white", "headalt" => "payday loans niagara falls ontario"];
          ...
          {
          	$data = ["bannerbg" => "images/falls.jpg", "licpr" => "on", "spprov" => "Niagara Falls", "headpg" => "Accessing The Personal Loan Industry in Canada", "headtxtcolor" => "white", "headalt" => "payday loans niagara falls ontario"];
          ...
          public function whattoshopfor()
          {
          	$data = ["bannerbg" => "images/falls.jpg", "licpr" => "on", "spprov" => "Niagara Falls", "headpg" => "Bad Credit Loans - What To Shop For", "headtxtcolor" => "white", "headalt" => "payday loans niagara falls ontario"];
          	SEOMeta::setTitle('Bad Credit Loans - What To Shop For');
          	SEOMeta::setDescription('A suddenly bad financial situation can have a massive impact on you and your plans, whether you need to buy something unforeseen, or simply get to the end of the month and payday. In life, unexpected circumstances can easily become the norm when you are in need of funds and with no savings, you will be in a very challenging position. So, as a solution, look at taking loans for bad credit from reliable companies.');
          	SEOMeta::addKeyword('payday near me, cash check online instantly Canada, loans payday online, loans for bad credit, loans payday, online loans payday, payday loan near me, loan with bad credit, loans for bad credit, bad credit loans,  online personal loans, payday loans online, instant loan, payday loans, loans bad credit, personal loans, personal loan, borrowing money online');
          	return view('/blog/what-to-shop-for', $data);
          }

          public function DoYouReallyWanttoGetMoneyfromTheLocalLoanStore()
          {
          	$data = ["bannerbg" => "images/falls.jpg", "licpr" => "on", "spprov" => "Niagara Falls", "headpg" => "Do You Really Want to Get Money from The Local Loan Store?", "headtxtcolor" => "white", "headalt" => "payday loans niagara falls ontario"];
          	SEOMeta::setTitle('Do You Really Want to Get Money from The Local Loan Store?');
          	SEOMeta::setDescription('If you are looking to get a payday loan to meet some unforeseen circumstance, your first thought is probably one of those local Money Mart near me stores you see on main roads around the city.');
          	SEOMeta::addKeyword('payday near me, cash check online instantly Canada, loans payday online, loans for bad credit, loans payday, online loans payday, payday loan near me, loan with bad credit, loans for bad credit, bad credit loans,  online personal loans, payday loans online, instant loan, payday loans, loans bad credit, personal loans, personal loan, borrowing money online');
          	return view('/blog/Do-You-Really-Want-to-Get-Money-from-The-Local-Loan-Store', $data);
          }

          public function CanABadCreditReportbeGOODforyou()
          {
          	$data = ["bannerbg" => "images/falls.jpg", "licpr" => "on", "spprov" => "Niagara Falls", "headpg" => "Can A Bad Credit Report Be GOOD For You?", "headtxtcolor" => "white", "headalt" => "payday loans niagara falls ontario"];
          	SEOMeta::setTitle('Can A Bad Credit Report Be GOOD For You?');
          	SEOMeta::setDescription('If you have fallen behind on bills, or were wiped out by the Festive Season, you may be finding that borrowing money has become tougher. The reason may be your Credit Report.');
          	SEOMeta::addKeyword('payday near me, cash check online instantly Canada, loans payday online, loans for bad credit, loans payday, online loans payday, payday loan near me, loan with bad credit, loans for bad credit, bad credit loans,  online personal loans, payday loans online, instant loan, payday loans, loans bad credit, personal loans, personal loan, borrowing money online');
          	return view('/blog/Can-A-Bad-Credit-Report-be-GOOD-for-you', $data);
          }
